...
<?php global $metadescription, $title, $page_url, $page_title, $site_url, $socialimg, $socialimg_id, $gmt_published, $gmt_modified, $global_socialimg, $socialimg, $socialimg_h, $socialimg_w, $socialimg_alt, $current_page_parent_menu_id, $parent_title, $parent_url, $cat_title, $cat_url; ?>
    ...
    // 4. Breadcrumbs
    {
      ...
      "itemListElement":
       [
        ...
        <?php if( is_single()) : ?>
        // 4b. if is a Storytelling Video
        //     $parent variables set to Storytelling Videos
        ,{
         "@type": "ListItem",
         "position": 2,
         "item":
        ...
        // 4d. if NOT homepage
        //     AND
        //     is search  OR  is top level  OR  is an About menu child (79)
        ,{
         "@type": "ListItem",
         "position": 2,
         "item":
